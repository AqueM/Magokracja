...
Jedynym, który nie skapitulował był Nelson Mirtlass, w tamtej chwili niemal ucieleśniajacy ideał spokoju i niezachwiania maga Pyłu. To spowodowało, że dotknęła go "boska inspiracja" [[Hel]] i ruszył na przeciw przyzywanego Derniere. Oddał się we władanie jakiejś [[Siły Wyższe]], aby zatrzymać rytuał przyzwający Derniere, stając w magicznych płomieniach. Udało mu się to i Derniere nie został zmuszony do **Dokonania Zmiany** (patrz Derniere), jednak od tamtej pory jest agentem siły, która go poprowadziła/przejeła.

Po tym, jak Derniere przestał przybywać, zaćmienie się skończyło - bańka otwarła się pod wpływem tej samej siły, która dotknęła Nelsona. Mana się wylała, dając "kopa" okolicznym magom. 

Żołnierze Spektrum Emocji posługujący się [[Pył]], którzy jako ostatni niejako utrzymywali jeszcze pozycje, byli dzięki temu zdolni zwyczajnie _zamieść_ Stalową Kawalerię. To przywróciło nadzieję i odbudowało morale reszty Emocjowców, odwracając losy bitwy i wygrywając ją dla Spektrum Emocji.
...
Ten problem znany jest wśród [[Ludy poza Imperium]] jako wyprorokowana "Nieuchronna Bitwa Zaćmienia" która ma wydarzyć się w przyszłości, a włąściwie to w czasie [[Zjazd dyplomatyczny w Krondstadt]]. 
